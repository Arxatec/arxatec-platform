  ...
  return (
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          toast:
            "p-4 transition-all duration-300 border-none flex shadow-none gap-2 rounded-lg relative!",
          ...
          loading: "text-stone-100 bg-stone-50/5 gap-2 pl-10 text-base px-10",
